...
class SignUpForm(UserCreationForm):
    ...
    username =forms.EmailField(label="Nombre de Usuario", required=True, widget=forms.EmailInput(
    ...
    birthday = forms.DateField(label="Fecha de Nacimiento", required=True, widget=forms.DateInput(
      attrs={'class':'form-control', 'rows':2, 'placeholder':'Escribe tu fecha de nacimiento'}  
    ))
